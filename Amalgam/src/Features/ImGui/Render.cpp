...
void CRender::LoadFonts()
{
	...
	FontSmall = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\impact.ttf)", H::Draw.Scale(15), &tFontConfig);
	FontRegular = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\impact.ttf)", H::Draw.Scale(15), &tFontConfig);
	FontBold = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\impact.ttf)", H::Draw.Scale(15), &tFontConfig);
	FontLarge = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\impact.ttf)", H::Draw.Scale(16), &tFontConfig);
	FontMono = io.Fonts->AddFontFromFileTTF(R"(C:\Windows\Fonts\impact.ttf)", H::Draw.Scale(16), &tFontConfig); // windows mono font installed by default
#else
